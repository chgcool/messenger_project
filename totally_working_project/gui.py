...
class log_in:
	...
	def create_fields(self):
		...
		self.password_box.bind('<Return>', lambda e:self.check())
	...
	def check(self):
		...
		if password == "":
			password = "wrongpasswordaaaaayesitswrong"
...
class create_conversation:
	...
	def __init__(self, root):
		...
		self.text.bind('<Return>', lambda e:self.enter())
		self.text.pack()
		self.text.focus_set()
...
class messagebox:
	...
	def __init__(self, root, text):
		...
		Button(self.root, text='leave', command=self.leave).pack()
